        ...
        model_config = {
            ...
            MODEL_SELECTION_KEY: {
                "module_0": {
                    ...
                    PARAM_KEY: {"param_name1": "value1", "param_name2": "value2",},
...
class ModelFactory:
    def __init__(
        self, model_config_path: str = None,
    ):
        try:
        ...
        try:
            ...
            for model_serial_number in self.models_initialization_config.keys():
                ...
                if PARAM_KEY in model_initialization_config:
                    ...
                    model1 = ModelFactory.update_property_of_class(
                        instance_ref=model1, property_data=model_obj_property_data
                    )
